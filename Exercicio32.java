//32) Ler o nome de 2 times e o número de gols marcados na partida (para cada time). Escrever o nome do vencedor. Caso
//não haja vencedor deverá ser impressa a palavra EMPATE. 
